...
"""Post‑processing replication-level simulation results.

This script provide post-processing of the replication output that is now
generated by PoPS border via the updates made to outputs.py. See docs/outputs.md for details
on the functionality and how to operate.
"""
